...
- **[Scrying](./scrying.md):** Observe active Invocations, Ghoul labor, logs, traces, and approval waits.
- **[Nexus](./nexus.md):** Inspect Dispatcher routing, Orchestrator state, Covens, Soulstones, Portals, and hardware pressure.
- **[Loom](./loom.md):** Browse and inspect Weaver workflow Patterns before they become Invocations.
- **[Reliquary](./reliquary.md):** Review artifacts, blessed outputs, retained evidence, and consecrated deliverables.
- **[Bindings](./bindings.md):** Manage user-facing connections, policy surfaces, provider references, and Altar preferences.
