...
Judgment can begin here. When a run pauses for approval, Scrying should show the waiting branch, its evidence, and the controls needed to consecrate or reject it.
