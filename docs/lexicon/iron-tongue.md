...
| **Suite** | Designed, versioned live coordination that must initiate or admit, await, retry, cancel, recover, correlate, or settle multiple separately owned Composition Invocations; a settled foreign reference alone is not a Suite. | [Compositions](../compositions/index.md#suites-do-not-dissolve-their-members) + Spellweaver (ADR 28) |
