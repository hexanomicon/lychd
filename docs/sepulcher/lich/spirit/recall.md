...
Smṛti is memory or remembering: a retained form of prior cognition becoming present cognition
...
present cue
    ↓
The Call addresses the seed-vault
    ↓
retrieval finds candidate Seeds
    ↓
authority + provenance + relevance filter them
    ↓
Context receives the selected form
    ↓
...
```text
this Seed has returned
        +
this provenance is visible
        +
this Sigil may use it here
        =
“I remember” as an attributable claim
```

Where provenance or authority is absent, the honest Answer changes form: _this seems familiar_,
_the model prior suggests_, or _a record resembles the present case_. Fluency may not silently
upgrade resemblance into testimony.
...
- A correct record can be recalled into the wrong identity, task, or authority scope.
- A similarity search can retrieve a persuasive neighbor rather than the originating source.
- Repetition can make a weak claim feel inevitable without adding evidence.
- A relevant Seed can still be obsolete after the world has changed.

The cure is not perfect forgetting. It is governed return: source identity, relevance,
authorization, temporal context, contradiction checks, and the possibility of refusal.
...
> **The database does not remember. It preserves what may be called. The Spirit remembers when a
> Seed moves again.**

> _Next: [the Answer](../answer.md) speaks from what has returned._
