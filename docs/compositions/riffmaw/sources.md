...
A sound often arrives sideways: a timestamp, a mouth-made rhythm, a remembered drop, or the feel of
a transition. Sources turns that clue into an attributable, bounded musical reference.

> “At `01:32` it drops: _tz, tz, u-do_. Keep the pressure and spacing, change the musical matter.”

## Admit, index, mark

`riffmaw.index_sources@1` accepts only named files, recordings, or attributed artifacts. It bounds
...
`riffmaw.mark_moment@1` can use a timestamp, beat range, tapped rhythm, phrase, or other bounded
...
The source record can guide [Music](music.md), [Voice](voice.md), or [Sound](sound.md). It carries
no permission to copy, generate, spend, record a device, clone a voice, or publish.
