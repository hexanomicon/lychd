...
`riffmaw.forge_track@1` pins the sonic brief, admitted sources, `FeelProfile`, target form, budget,
and acceptance criteria. AI music generation may propose motifs, harmony, rhythm, timbre, sections,
or complete candidates. Human performance, manual composition, procedural systems, sampling, and
DAW editing may answer or replace those proposals. Every generated or transformed artifact keeps
its provider or tool revision, control material, seed when available, input and output digests,
cost, and source influence.
