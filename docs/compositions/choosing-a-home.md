...
```text
Product/use-case study exposes a need
→ candidate Composition tests the owner and defeat conditions
→ Portfolio acceptance establishes design truth
→ source enters only with an executable first-party contract
