...
Revision two keeps one private Discord guild, **The Necropolis**, one channel, `the-reach`, and a
...
Principal and current object grants; an unlinked member receives guest conversation with no
private records, tools, or effects. Discord roles may narrow visibility but never create a
