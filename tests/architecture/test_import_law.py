...
with one sanctioned structural exception: ``animation/extension.py`` extends the
``lychd.extensions.base.ExtensionStore`` base. This test locks the dependency
inversion (concrete runtimes live behind registered adapter/connector seams).
"""
