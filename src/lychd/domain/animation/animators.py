...
Animators are runic handles for live addressable services. They bind embodiment
kind (``Soulstone`` or ``Portal``) to a typed connector while keeping protocol
and capability behavior behind the connector layer. Deployment manifests stay
in the Bind/Scribe path and are not retained by these runtime handles.
"""
...
class Soulstone[C: Connector, R: SoulstoneConfig](Animator[C, R], ABC):
    """Local, LychD-managed Animator runtime handle."""
