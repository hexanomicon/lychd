...
from lychd.domain.animation.services.adapters.contracts import SoulstoneDefinition, SoulstoneRuntimeAdapter
...
class PortalStore(ExtensionStore):
    """Reserved store for remote/API model integrations."""
